...
public class MainPanel extends JPanel {
	...
	public MainPanel() {
		...
		displayButton.addActionListener(new displayButtonHandler());
		modifyButton.addActionListener(new modifyButtonHandler());
		queryButton.addActionListener(new queryButtonHandler());
	...
	private class addButtonHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// pop up
			int result = JOptionPane.showConfirmDialog(null, allPanel, "ADD", JOptionPane.OK_OPTION);
			...
			if (result == JOptionPane.OK_OPTION) {
				...
				try {
					...
					// create connection
					Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@acaddb2.asu.edu:1521:orcl",
							"tnguy107", "tnguy107");
					// create statement
					...
					String sql = "INSERT INTO club " + " VALUES ('" + name + "','" + id + "' ,'" + pres + "','"
							+ balance + "','" + vicePres + "')";
	...
	private class deleteButtonHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				// pop up
				int result = JOptionPane.showConfirmDialog(null, allPanel, "DELETE", JOptionPane.OK_OPTION);
	...
	private class modifyButtonHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				Class.forName("oracle.jdbc.driver.OracleDriver");
				// create connection
				Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@acaddb2.asu.edu:1521:orcl", "tnguy107",
						"tnguy107");
				// create statement
				Statement stmt = conn.createStatement();
				...
				int result = JOptionPane.showConfirmDialog(null, allPanel, "MODIFY", JOptionPane.OK_OPTION);
				...
				if (result == JOptionPane.OK_OPTION) {
					...
					String sql = String.format(
							"UPDATE club SET c_name = '%s', clubBalance = '%f', president = '%s' , vicePresident = '%s' WHERE clubID = '%s' ",
							name, balance, pres, vicePres, substring);
					System.out.println(sql);
	...
	private class queryButtonHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				// pop up
				int result = JOptionPane.showConfirmDialog(null, allPanel, "Query", JOptionPane.OK_OPTION);
